...
export function AmenitiesSection() {
  ...
  return (
    <section id="amenidades" ref={sectionRef} className="relative py-24 bg-gradient-to-b from-gray-50 to-amber-50/30">
      <div className="container mx-auto px-4 lg:px-8">
        <div
          className={`text-center mb-16 transition-all duration-1000 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}
        >
          <span className="inline-block px-4 py-2 bg-black text-white text-sm font-semibold tracking-wider uppercase rounded-full mb-6">Amenidades</span>
